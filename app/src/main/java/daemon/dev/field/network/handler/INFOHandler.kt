...
//            for ((c, h) in channels) {
//                if (NSM.channelInfo(c) != h) {
//                    dif.add(c)
//                }
//            }
//            Log.i("INFO.kt", "Have dif $dif")
//            if (dif.isNotEmpty()) {
//                val channel_to_list_of_post_address = channelAccess.resolveChannels(dif,NSM.channels.keys as List<String>)
//
//                Log.i(
//                    "INFO.kt",
//                    "Have channel_to_list_of_post_address $channel_to_list_of_post_address"
//                )
//
